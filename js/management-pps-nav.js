...
(() => {
  ...
  async function init() {
    ...
    try {
      ...
      const daily = addLink(nav,"daily-review-link","daily-review.html","Daily Review (Pilot)",woPriority);
      addLink(nav,"sales-order-dashboard-link","sales-order-dashboard.html","Sales Order Dashboard (Pilot)",daily);
    } catch {
